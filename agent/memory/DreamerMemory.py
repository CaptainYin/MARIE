...
class DreamerMemory:
    ...
    def init_buffer(self, n_agents, env_type):
        ...
        self.av_actions = np.empty((self.capacity, n_agents, self.action_size),
                                   dtype=np.float32) if env_type in [Env.STARCRAFT, Env.SMAX, Env.SMACv2] else None
    ...
    def get_transitions(self, idxs):
        ...
        av_action = self.process_batch(self.av_actions, vec_idxs, batch_size)[1:] if self.env_type in [Env.STARCRAFT, Env.SMAX, Env.SMACv2] else None
    ...
    def get_transitions_n(self, idxs):
        ...
        av_action = self.process_batch(self.av_actions, vec_idxs, batch_size) if self.env_type in [Env.STARCRAFT, Env.SMAX, Env.SMACv2] else None
    ...
    def sample_batch(self, bs, sl, mode="tokenizer"):
        ...
        av_action = self.process_batch(self.av_actions, vec_idxs, batch_size, sl) if self.env_type in [Env.STARCRAFT, Env.SMAX, Env.SMACv2] else None
